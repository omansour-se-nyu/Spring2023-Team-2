...
urlpatterns = [
    ...
    path('staff/patients/records/update/', views.create_patient_records, name="Update Patient Records"),
    path('staff/patients/records/delete/', views.create_patient_records, name="Delete Patient Records"),
