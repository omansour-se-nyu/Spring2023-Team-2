...
class StayInformationModel(models.Model):
    ...
    start_time = models.DateTimeField()  # time when patient was admitted
    end_time = models.DateTimeField()  # time when patient left
...
class RoomInformationModel(models.Model):
    ...
    availability_status = models.BooleanField()  # logical column, indicating if room is free or not
...
class AffiliatedWithModel(models.Model):
    ...
    primary_affiliation = models.BooleanField()  # indicating if department/doc are affiliated yet
